...
public class SeqManager extends SequenceStyleGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
        /*
        if (object instanceof SmsManagerEntity) {
            SmsManagerEntity sms = (SmsManagerEntity) object;
            return sms.getSmsSeq() == null ?
                    valueUserParameter + String.format(numberFormat, super.generate(session, object))
                    : sms.getSmsSeq();
        }
        */
